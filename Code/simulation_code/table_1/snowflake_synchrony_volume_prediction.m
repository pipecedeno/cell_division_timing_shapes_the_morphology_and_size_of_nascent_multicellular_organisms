...
The modifications for this code are in ELYES_SIM, the main loop and a lot of the plot 
...
%Grande directory
% directory_path = '~/work_dir/observed_synchrony/evolution_results/size_difference_prediction_10june2024/grande_3000m_50n/edges_sim_files';
% strain='grande';
% Petite directory
directory_path = '~/work_dir/observed_synchrony/evolution_results/size_difference_prediction_10june2024/petite_3000m_50n/edges_sim_files';
strain='petite';
...
% output_filename = fullfile(output_folder, 'grande_volume_pred_synchrony_2024june11.csv');
% output_filename = fullfile(output_folder, 'petite_volume_pred_synchrony_2024june11.csv');
% test all outputs combined
output_filename = fullfile(output_folder, 'petite_volume_pred_synchrony_all_param_2024june11.csv');
...
overlap_thresh  = 236.085; % threshold of total overlaps %#2.5e2
% overlap_vec = 1.0*10.^(1.0:0.2:3.0);

% to test the what is the effect of all variables combined
AR              = 1.22;
diam            = 4.844;
