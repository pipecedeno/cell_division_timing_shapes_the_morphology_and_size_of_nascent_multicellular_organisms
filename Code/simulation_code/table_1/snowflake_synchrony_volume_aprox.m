...
if write_to_output_file==1
    ...
    % Add file header
    fprintf(volume_size_output, 'overlap_thresh,sim_number,file_number,num_cells,volume_clust\n');
end
    ...
    if ~isempty(match)
        ...
        for a = 1:length(overlap_vec)
            ...
            for ii = 1:N
                ...
                if write_to_output_file==1
                    fprintf(volume_size_output, '%d,%d,%d,%d,%d\n', overlap_thresh, ii, file_number, length(cell_list), V);
                end
