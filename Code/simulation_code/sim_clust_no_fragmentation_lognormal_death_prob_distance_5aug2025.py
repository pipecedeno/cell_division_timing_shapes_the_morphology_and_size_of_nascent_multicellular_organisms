...
def divide_cells(cluster_population, cells_to_divide, first_div_params, second_div_params, death_prob, cont_ids):
...
def simulate_one_cluster_growth(input_variables, first_div_params, second_div_params, death_prob):
	...
	while len(cells_to_divide) > 0 and snowflake.number_of_nodes() < max_clust_size:
		...
		cont_ids, cells_to_divide = divide_cells(snowflake, cells_to_divide, first_div_params, second_div_params, death_prob, cont_ids)
...
for i in range(1, num_iterations + 1):
	...
	attempt = 1
	while True:
		success, results_table, distance_results_table, degree_results_table, network_files = simulate_one_cluster_growth(input_variables, first_div_params, second_div_params, death_prob)
		if success:
