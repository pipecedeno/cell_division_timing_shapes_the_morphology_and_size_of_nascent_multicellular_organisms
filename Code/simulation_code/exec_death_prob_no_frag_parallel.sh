...
run_simulation() {
    ...
    cmd="sim_clust_no_fragmentation_lognormal_death_prob_5aug2025.py -n ${sim_number} -o ${output_dir} -m ${max_clust_size} -i ${first_div_params} -j ${second_div_params} -p ${death_prob}"
